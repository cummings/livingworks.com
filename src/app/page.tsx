    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 absolute top-[15%] z-10 px-4">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-15 mt-12 md:mt-16">
          <div className="flex flex-col items-center uppercase tracking-wider">
          <div className="text-3xl sm:text-5xl lg:text-6xl font-bold text-center">You're Not Invisible</div>
          <div className="text-4xl sm:text-6xl lg:text-7xl font-bold text-center">You're Just Early</div>
          </div>
          <div className="text-center px-4 text-md lg:text-2xl">
          <div className="font-bold ">For the Creators, Founders, Leaders, Renegades</div>
          <div >who passionately create</div>
          <div >what the future can't automate,</div>
          </div>
          <div className='uppercase font-bold text-md  lg:text-2xl'>you're in the right place.</div>
          </div>

          </div>

          <div className='text-center px-4 pb-2  text-md lg:text-2xl'>
        ...
        <div className='min-h-screen py-12 md:py-16 flex flex-col items-center justify-center w-full bg-black px-4'>
          ...
          <div className='text-center'>
            <div className='uppercase text-md lg:text-xl'>welcome to</div>
            <Image src="images/logo.svg" alt="Living Works" width={205.67} height={60} className="mx-auto" />
            </div>
            <div className='text-center text-md lg:text-xl mt-4'>
